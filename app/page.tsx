        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-3xl mx-auto">
            {[
              ...
              { n: "Pro Launch", p: "$9", oldP: "$19", d: "30 articles / month", f: ["Everything in Starter", "30 articles per month", "Priority generation speed", "Email support", "Early access to new features"], hl: true, priceId: "pri_01kwxmrt4r0y3143tj0pz5e7d1", badge: "First month", btn: "Get Pro — $9/mo", btnStyle: "bg-blue-600 text-white hover:bg-blue-700" },
              { n: "Founding Member", p: "$79", oldP: "$199", d: "Lifetime · 100 articles/mo", f: ["Everything in Pro", "100 articles per month", "Lifetime access, no recurring", "Custom brand voice (coming)", "Bulk generation (coming)", "API access (coming)"], hl: false, priceId: "pri_01kwxmqxt5cwcv5tf32g4gn5kd", badge: "Best value", btn: "Get lifetime access", btnStyle: "bg-green-500 text-white hover:bg-green-600" },
            ].map((plan) => (
